...
#if DT_NODE_HAS_STATUS(DT_NODELABEL(i3c0), okay) && (CONFIG_I3C_NPCM4XX || CONFIG_I3C_NPCM4)
FUN_DEFINE(DT_NODELABEL(pinctrl_i3c0_default), I3C1_SCL, I3C1_SDA)
#endif

#if DT_NODE_HAS_STATUS(DT_NODELABEL(i3c4), okay) && (CONFIG_I3C_NPCM4XX || CONFIG_I3C_NPCM4)
FUN_DEFINE(DT_NODELABEL(pinctrl_i3c4_default), I3C5_SCL, I3C5_SDA)
#endif

#if DT_NODE_HAS_STATUS(DT_NODELABEL(i3c5), okay) && (CONFIG_I3C_NPCM4XX || CONFIG_I3C_NPCM4)
