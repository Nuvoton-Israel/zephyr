...
typedef struct {
    ...
    //uint8_t hFwRbkValidLog[32];        // 6694

    //uint8_t hImageCodeHash[32];
...
//extern unsigned long __data_seg_start__;
//extern unsigned long __data_seg_end__;


__attribute__ ((section(".header")))
FIRMWARE_HEDAER_TYPE fw_header = {
        //.hUserFWEntryPoint = (uint32_t)(&__isr_vector),
