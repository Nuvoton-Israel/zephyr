...
#define Z_PINCTRL_NPCX_HAS_DRIVE_PROP(node_id, node_periph)                                        \
	UTIL_AND(DT_PROP(node_id, drive_open_drain), DT_NODE_HAS_PROP(node_periph, pwm_channel))

#define Z_PINCTRL_NPCX_HAS_PSL_IN_PROP(node_id)                                                    \
	UTIL_AND(DT_NODE_HAS_PROP(node_id, psl_in_pol), DT_NODE_HAS_PROP(node_id, psl_in_mode))
