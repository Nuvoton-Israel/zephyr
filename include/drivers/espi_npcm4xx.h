...
#ifndef ZEPHYR_INCLUDE_DRIVERS_ESPI_NPCM4XX_H_
#define ZEPHYR_INCLUDE_DRIVERS_ESPI_NPCM4XX_H_

struct espi_npcm4xx_ioc {
	uint32_t pkt_len;
	uint8_t pkt[68];
};
...
#define NPCM4XX_FLASH_RX_CYC                FIELD(8, 8)
#define NPCM4XX_FLASH_RX_LEN_H              FIELD(16, 4)
#define NPCM4XX_FLASH_RX_TAG                FIELD(20, 4)
#define NPCM4XX_FLASH_RX_LEN_L              FIELD(24, 8)
#define NPCM4XX_FLASH_RX_LEN_H_SHIFT        8
